...
// 2000, not 400. `reviewer` runs at effort: xhigh and adaptive thinking is charged against the
// SAME ceiling as the answer — at 400 the live check got back a literal "". The reply we want is
// three short lines; the headroom is for the reasoning that produces them.
function modelVerifier({ agent = 'reviewer', passScore = DEFAULT_PASS_SCORE, maxTokens = 2000 } = {}) {
