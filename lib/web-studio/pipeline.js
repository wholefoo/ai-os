...
async function createSiteFromBrief(opts, deps) {
  const { workspaceDir, brief, siteId, domain, siteName, design, scraped, research, affiliateUrl, features, platformBaseUrl, modelOverride } = opts;
  ...
  const planResp = await executeAgent('web-studio-lead', planPrompt(brief, { domain, siteName, design, scraped, research }), { maxTokens: 16000, untrusted: scrapedUntrusted, modelOverride });
