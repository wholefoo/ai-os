...
// DESC_MAX is the only band constant a test asserts against; the rest are internal.
module.exports = { auditPage, auditSite, proposeFixes, applyFixes, trimToWord, trimToSentence, DESC_MAX };
