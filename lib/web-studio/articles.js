...
function normalizeArticle(input, opts = {}) {
  ...
  return {
    ...
    publishedAt: isoOrNull(a.publishedAt) || (existing ? existing.publishedAt : null) || now,
    updatedAt: now,
...
module.exports = {
  slugify, normalizeArticle, expandArticlePages, publishedArticles, articlePath, indexPath,
  articleLd, metaLine, readingMinutes, wordCount, isoOrNull,
