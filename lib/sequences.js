...
//   sequence   = { id, name, trigger: 'site-lead'|'free-audit'|'all-leads', siteId|null, enabled,
...
function validateSequence(seq) {
  ...
  if (!['site-lead', 'free-audit', 'all-leads'].includes(seq.trigger)) errs.push('trigger must be site-lead, free-audit, or all-leads');
