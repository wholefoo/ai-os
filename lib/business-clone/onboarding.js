...
const DISCLOSURE = {
  ...
  points: [
    ...
    },
    {
      ...
      body: 'Only you. Your answers, the profile built from them, and the exact instructions your clone receives are all visible to you and to nobody else on this instance.',
    },
    {
      heading: 'You can correct or delete it',
      body: 'Every field is editable, and deleting the clone deletes the profile it learned. You are never stuck with something it got wrong about you.',
    },
    {
