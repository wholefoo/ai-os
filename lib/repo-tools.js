...
const LIMITS = Object.freeze({
  ...
  maxFileBytes: 512 * 1024, // per file, for Grep: larger than this is a bundle/artifact, not source
...
function newBudget(limits) {
  return { files: 0, bytes: 0, deadline: Date.now() + limits.timeBudgetMs, stopped: null };
}
...
const noteFor = (budget) => {
  ...
  return `\n\n[... SEARCH INCOMPLETE: stopped ${why}. This is NOT "no more matches" — narrow the`
