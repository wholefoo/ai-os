...
function buildAgentCard({ baseUrl }) {
  ...
  return {
    ...
    description: 'A self-hosted virtual company of AI agents across 10 departments, exposing a curated set of skills over A2A. Access is not open: calling this endpoint requires a bearer token provisioned by the instance operator.',
    url: `${url}/api/a2a`,
...
module.exports = { buildAgentCard, resolveSkill, extractText };
