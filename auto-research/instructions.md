...
- Facts must stay true: 68 agents, 11 departments, open-source core, self-hosted, Business license $1,997 one-time, Enterprise $4,997 one-time. Never invent statistics, customer counts, or awards.
