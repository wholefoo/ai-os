...
// --- Tour Guide Avatar Logic ---
  const tourGuideData = {
    ...
    tours: {
      overview: [
        { msg: "AI OS is a Virtual Corporate Headquarters — imagine a full company staffed by 68 AI agents, each with a name, role, and department. And you stay in the loop: important actions wait for your approval in Auto-Mode.", delay: 0 },
      ...
      licensing: [
        ...
        { msg: "Business license is a one-time $1,997 — unlocks all 68 agents, all production tools, and self-instance theming so you can brand your own private instance with your name, logo, and colors.", delay: 4000 },
      ...
      pricing: [
        ...
        { msg: "Business — $1,997 one-time license. All 68 agents, all production tools, and self-instance theming to brand your own private instance.", delay: 4500 },
