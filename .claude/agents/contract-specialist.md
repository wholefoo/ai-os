...
description: "Generates standard contracts from templates (NDA, SLA, vendor, partnership), reviews incoming contracts for unfavorable terms, and manages contract lifecycle and renewals. Use for routine contract work; do NOT use for regulatory/privacy audits (use compliance-officer), software/commercial license agreements (use commercial-licensing-specialist), or novel legal questions — escalate those to general-counsel."
model: claude-opus-5
effort: high
tier: professional
