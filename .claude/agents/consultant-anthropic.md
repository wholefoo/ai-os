...
- **Current models (IDs):** Claude Fable 5 (`claude-fable-5`, $10/$50 per 1M — most capable, opt-in premium), Claude Opus 5 (`claude-opus-5`, $5/$25 — the platform default), Claude Sonnet 5 (`claude-sonnet-5`, $2/$10 — made the standard price 2026-08-10; the scheduled rise to $3/$15 was cancelled), Claude Haiku 4.5 (`claude-haiku-4-5`, $1/$5).
